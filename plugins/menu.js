...
║│⬡ Instagram :
║│⬡ https://instagram.com/Zippyseve59
║╰───────────
╰━━━━━━━━━━━━❀`.trimStart(),
    header: '║╭──〘 %category 〙─❉',
...
await conn.fakeReply(m.chat, 'Loading...', '0@s.whatsapp.net', 'KELVIN ', 'status@broadcast')
 conn.send3ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), footer, 'pemilik bot', '.owner', 'data ozawa', '.infoozawa', 'rules', '.rules', m)
